 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://vodafone.com/", wsdlLocation = "http://localhost:9090/wsdl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://vodafone.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/wsdl?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://vodafone.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://vodafone.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
